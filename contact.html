        ...
        <nav class=" header-color navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="dropdown-item" href="/web-design-development.html">Web design & development</a>
                    <a class="dropdown-item" href="/animated-video.html">Video animation</a>
                    <a class="dropdown-item" href="/brand-marketing.html">Brand marketing</a>
